...
要了解有关何时将测试表达式求值为 true（非零值）和 false（0）的更多信息，请检查[关系式](/c-programming/c-operators#relational "C Relational operators")和[逻辑运算符](/c-programming/c-operators#logical "C logical operators")。
